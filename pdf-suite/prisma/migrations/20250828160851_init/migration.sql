-- CreateEnum
CREATE TYPE "public"."JobStatus" AS ENUM ('queued', 'running', 'completed', 'failed', 'canceled');
...
CREATE TABLE "public"."User" (
    ...
    "passwordHash" TEXT,
    "planId" TEXT,
    "quotaUsedMB" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "public"."Plan" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "maxFileMB" INTEGER NOT NULL,
    "monthlyQuotaMB" INTEGER NOT NULL,
...
-- AddForeignKey
ALTER TABLE "public"."Job" ADD CONSTRAINT "Job_outputFileId_fkey" FOREIGN KEY ("outputFileId") REFERENCES "public"."File"("id") ON DELETE SET NULL ON UPDATE CASCADE;
